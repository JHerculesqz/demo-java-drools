...
public class TestVo {
	...
	public void recordPointLog(String userName, String type) {
		...
		System.out.println("执行完毕BillThisMonth：" + this.getBillThisMonth());
		System.out.println("执行完毕BuyMoney：" + this.getBuyMoney());
		System.out.println("执行完毕BuyNums：" + this.getBuyNums());
		System.out.println("执行完毕Point：" + this.getPoint());
	}
